// Verbatim from github.com/JorgeCapillo/webgl-progressive-blur
// (src/js/components/Media.js). Only change: shaders imported from the inlined
// ./shaders module instead of .glsl files. Algorithm unchanged.
